@extends('admin.home')
@section('title', 'Quản lý nhận xét thành viên')
@section('body')
	<section id="comment_admin">
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
					<div class="block ablock-newest">
						<div class="block-cap">
							<h2>PHÊ DUYỆT NHẬN XÉT</h2>
						</div>
						<div class="block-content">
							@if($a_articles->count() == 0)
								<div>Không có nhận xét nào cần kiểm duyệt</div>
							@else
