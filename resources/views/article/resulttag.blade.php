...
@section('title', 'Kết quả tìm kiếm '.$tag)
@section('body')
	<section id="block_search" class="block">
        <div class="container">
            <div class="row">
                ...
                <div class="block-content">
                    @if($tags[0]->articles()->get()->count()== 0)
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">Không tìm thấy kết quả nào cho {{$tag}}</div>
                    @else
                        @foreach($tags[0]->articles()->get() as $art)
                         <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                            @if($art->type=='video')
                                <div id="{{rand(100,999).'_art_'.$art->idv}}" class="item-block item-{{$art->type}}">
                                    ...
                                    <div claass="title-item">
                                        <h3><a href="https://www.youtube.com/watch?v={{$art->idv}}"><?php //echo youtube($vId)['snippet']['title'] ?></a></h3>
                                    </div>
                            ...
                            @else
                                <div id="{{rand(100,999).'_art_'.$art->id}}" class="item-block item-{{$art->type}}">
                                    <div class="desc-thumb">
                                        <div class="thumb-item">
